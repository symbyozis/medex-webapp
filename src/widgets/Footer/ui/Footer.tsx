...
const socLinks = [
  {
    ...
    link: `https://www.instagram.com/${appConfig.contacts.instagram}`,
  },
  {
    icon: <Telegram fontSize="inherit" />,
    link: `https://t.me/${appConfig.contacts.telegram}`,
  },
];
...
const contacts = [
  ...
  },
  {
    ...
    text: phoneFormat(appConfig.contacts.phone),
  },
  {
    icon: <PlaceOutlined fontSize="inherit" />,
    link: appConfig.contacts.google_map_link,
    text: appConfig.contacts.address,
  },
];
              ...
              <Grid size={{ md: 4 }}>
                ...
                <form>
                  <div className="relative flex flex-wrap items-stretch w-full">
                    <input
                      type="email"
                      className="block h-[calc(1.5em+0.75rem+2px)] px-3 py-[0.375rem] relative flex-1 w-[1%] mb-0 text-base font-normal leading-[1.5] text-[#495057] bg-transparent border border-[var(--primary-color)] rounded-l-[50px] transition-all duration-150 ease-in-out placeholder:text-black placeholder:text-sm placeholder:font-light placeholder:italic placeholder:pl-[14px]"
