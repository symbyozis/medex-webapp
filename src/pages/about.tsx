  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Клиника «Здоровье+» в Назрани работает с 1999 года. Терапевт, гинеколог, уролог, лаборатория и УЗИ под одной крышей. 26 лет заботимся о здоровье жителей Ингушетии." key="description" />
        <meta name="keywords" content="клиника Назрань, медицинская клиника Ингушетия, Здоровье плюс, о клинике, клиника с 1999" />
        ...
        <meta property="og:description" content="Клиника «Здоровье+» в Назрани работает с 1999 года. Терапевт, гинеколог, уролог, лаборатория и УЗИ под одной крышей." />
        ...
        <Container>
          <Grid container spacing={6} alignItems="center">
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              <Typography sx={{ mb: 2 }}>
                Мы работаем с 1999 года. За это время тысячи пациентов из Назрани и Республики
