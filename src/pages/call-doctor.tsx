...
const PAGE_DESCRIPTION =
  "Вызов врача на дом в Назрани и Республике Ингушетия. Опытный терапевт приедет на дом: осмотр, диагностика, назначение лечения, забор анализов. Работаем с 1998 года. Запишитесь по телефону +7 928 799-73-99.";
...
const benefits = [
  ...
  },
  {
    ...
    text: "Принимаем с 1998 года. На дом выезжает врач, который проведёт полноценный осмотр и назначит лечение.",
  },
  {
...
const faq = [
  ...
  },
  {
    ...
    a: "Мы выезжаем по Назрани и ближайшим населённым пунктам Республики Ингушетия. Точную возможность выезда по вашему адресу уточните при звонке.",
  },
  {
    q: "Какой врач приезжает на дом?",
    a: "На дом выезжает терапевт клиники «Здоровье+». При необходимости врач даст направление к узким специалистам и на дополнительную диагностику.",
  },
  {
            ...
            <Grid container spacing={4} alignItems="center">
              <Grid size={{ xs: 12, md: 7 }}>
                ...
                <Typography sx={{ mb: 2, color: "#585858" }}>
                  ...
                  Мы работаем с 1998 года и заботимся о здоровье жителей региона уже более
                  26 лет.
                </Typography>
